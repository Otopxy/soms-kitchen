    ...
    <section className="announcement section-shell" aria-labelledby="anniversary-announcement-title">
      <div className="announcement-card">
        ...
        <div className="announcement-card__content">
          <p className="announcement-card__kicker">June 2026 customer thank-you</p>
          ...
          <p>
            ...
            more years to come! As a thank you, we are adding a free souvenir gift to every order on the 4th and 5th of June,
            2026.
          </p>
